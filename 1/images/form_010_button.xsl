	...
	<div class="style-custom" style="display: none">
		<div class="rule">
			...
			<span class="rule-dynamic">
				...
				<xsl:attribute name="data-colors"><xsl:value-of select="$bg-color-fixed"/>|0;<xsl:value-of select="$main.sColor2"/>|100</xsl:attribute>
			</span>
		</div>
		<div class="rule">
			<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-btn:hover</xsl:attribute>
			<span class="rule-dynamic">
				<xsl:attribute name="data-type">linear-gradient</xsl:attribute>
