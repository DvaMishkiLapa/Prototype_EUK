	...
	<div>
		...
		<xsl:choose>
			<xsl:when test="$theme='simple'">
				...
				<xsl:variable name="css-simple-cl-txt-box-table">width: <xsl:value-of select="number($width) - 2*number(text_padding) - 8"/>px; border-spacing: 0; <xsl:if test="size_to='container'">min-height: <xsl:value-of select="$simple-box-min-height"/>px;</xsl:if></xsl:variable>
				<xsl:variable name="css-simple-cl-txt-box-cell">width: <xsl:value-of select="number($width) - 2*number(text_padding) - 8"/>px; padding: 0; <xsl:if test="size_to='container'">vertical-align: <xsl:value-of select="valign"/>; min-height: <xsl:value-of select="$simple-box-min-height"/>px;</xsl:if></xsl:variable>
			...
			<xsl:when test="$theme='light'">
				...
				<xsl:variable name="css-light-cl-txt-box-table">width: <xsl:value-of select="number($width) - 2*number(text_padding) - 10"/>px; border-spacing: 0; <xsl:if test="size_to='container'">min-height: <xsl:value-of select="$light-box-min-height"/>px;</xsl:if></xsl:variable>
				<xsl:variable name="css-light-cl-txt-box-cell">width: <xsl:value-of select="number($width) - 2*number(text_padding) - 10"/>px; padding: 0; <xsl:if test="size_to='container'">vertical-align: <xsl:value-of select="valign"/>; min-height: <xsl:value-of select="$light-box-min-height"/>px;</xsl:if></xsl:variable>
			...
			<xsl:when test="$theme='standard'">
				...
				<xsl:variable name="css-standard-cl-txt-box-table">width: <xsl:value-of select="number($width) - 2*number(text_padding) - 20"/>px; border-spacing: 0; <xsl:if test="size_to='container'">min-height: <xsl:value-of select="$standard-box-min-height"/>px;</xsl:if></xsl:variable>
				<xsl:variable name="css-standard-cl-txt-box-cell">width: <xsl:value-of select="number($width) - 2*number(text_padding) - 20"/>px; padding: 0; <xsl:if test="size_to='container'">vertical-align: <xsl:value-of select="valign"/>; min-height: <xsl:value-of select="$standard-box-min-height"/>px;</xsl:if></xsl:variable>
			...
			<xsl:when test="$theme='curve'">
				...
				<xsl:variable name="css-curve-cl-txt-box-table">width: <xsl:value-of select="number($width) - 2*number(text_padding) - 46"/>px; border-spacing: 0; <xsl:if test="size_to='container'">min-height: <xsl:value-of select="$curve-box-min-height"/>px;</xsl:if></xsl:variable>
				<xsl:variable name="css-curve-cl-txt-box-cell">width: <xsl:value-of select="number($width) - 2*number(text_padding) - 46"/>px; padding: 0; <xsl:if test="size_to='container'">vertical-align: <xsl:value-of select="valign"/>; min-height: <xsl:value-of select="$curve-box-min-height"/>px;</xsl:if></xsl:variable>
			...
			<xsl:when test="$theme='gradient'">
				...
				<xsl:variable name="css-gradient-cl-txt-box-table">width: <xsl:value-of select="number($box-width) - 2*number(text_padding) - 36"/>px; border-spacing: 0; <xsl:if test="size_to='container'">min-height: <xsl:value-of select="$gradient-box-min-height"/>px;</xsl:if></xsl:variable>
				<xsl:variable name="css-gradient-cl-txt-box-cell">width: <xsl:value-of select="number($box-width) - 2*number(text_padding) - 36"/>px; padding: 0; <xsl:if test="size_to='container'">vertical-align: <xsl:value-of select="valign"/>; min-height: <xsl:value-of select="$gradient-box-min-height"/>px;</xsl:if></xsl:variable>
			...
			<xsl:when test="$theme='relief'">
				...
				<xsl:variable name="css-relief-cl-txt-box-table">width: <xsl:value-of select="number($width) - 2*number(text_padding) - 26"/>px; border-spacing: 0; <xsl:if test="size_to='container'">min-height: <xsl:value-of select="$relief-box-min-height"/>px;</xsl:if></xsl:variable>
				<xsl:variable name="css-relief-cl-txt-box-cell">width: <xsl:value-of select="number($width) - 2*number(text_padding) - 26"/>px; padding: 0; <xsl:if test="size_to='container'">vertical-align: <xsl:value-of select="valign"/>; min-height: <xsl:value-of select="$relief-box-min-height"/>px;</xsl:if></xsl:variable>
			...
			<xsl:when test="$theme='text'">
				...
				<xsl:variable name="css-text-cl-txt-box-table">width: <xsl:value-of select="number($width) - 2*number($border-width) - 2*number($padding-text)"/>px; border-spacing: 0; <xsl:if test="size_to='container'">min-height: <xsl:value-of select="$text-box-min-height"/>px;</xsl:if></xsl:variable>
				<xsl:variable name="css-text-cl-txt-box-cell">width: <xsl:value-of select="number($width) - 2*number($border-width) - 2*number($padding-text)"/>px; padding: 0; <xsl:if test="size_to='container'">vertical-align: <xsl:value-of select="valign"/>; min-height: <xsl:value-of select="$text-box-min-height"/>px;</xsl:if></xsl:variable>
			...
			<xsl:when test="$theme='custom'">
				...
				<xsl:variable name="css-custom-cl-txt-box-table">width: <xsl:value-of select="number($width) - 2*number($border-width) - 2*number($padding-custom)"/>px; border-spacing: 0; <xsl:if test="size_to='container'">min-height: <xsl:value-of select="$custom-box-min-height"/>px;</xsl:if></xsl:variable>
				<xsl:variable name="css-custom-cl-txt-box-cell">width: <xsl:value-of select="number($width) - 2*number($border-width) - 2*number($padding-custom)"/>px; padding: 0; <xsl:if test="size_to='container'">vertical-align: <xsl:value-of select="valign"/>; min-height: <xsl:value-of select="$custom-box-min-height"/>px;</xsl:if></xsl:variable>
