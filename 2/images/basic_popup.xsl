...
<xsl:template match="params">
	...
	<xsl:variable name="border-width-custom">
		<xsl:choose>
	...
	<xsl:variable name="btn-color-fixed">
		<xsl:call-template name="fix-color">
			<xsl:with-param name="color" select="btn_color"/>
		</xsl:call-template>
	</xsl:variable>

	<xsl:variable name="adjuster">
		<xsl:choose>
			<xsl:when test="$theme='simple'">
				<xsl:choose>
					<xsl:when test="display_header='no' and close_by='button'"><xsl:value-of select="number(text_padding) + 8"/></xsl:when>
					<xsl:when test="display_header='no' and close_by!='button'"><xsl:value-of select="2*number(text_padding) + 8"/></xsl:when>
					<xsl:otherwise><xsl:value-of select="2*number(text_padding) + 8"/></xsl:otherwise>
				</xsl:choose>
			</xsl:when>
			<xsl:when test="$theme='light'">
				<xsl:choose>
					<xsl:when test="display_header='no' and close_by='button'"><xsl:value-of select="number(text_padding) + 2"/></xsl:when>
					<xsl:when test="display_header='no' and close_by!='button'"><xsl:value-of select="2*number(text_padding) + 2"/></xsl:when>
					<xsl:otherwise><xsl:value-of select="2*number(text_padding) + 3"/></xsl:otherwise>
				</xsl:choose>
			</xsl:when>
			<xsl:when test="$theme='standard'">
				<xsl:choose>
					<xsl:when test="display_header='no' and close_by='button'"><xsl:value-of select="number(text_padding) + 4"/></xsl:when>
					<xsl:when test="display_header='no' and close_by!='button'"><xsl:value-of select="2*number(text_padding) + 4"/></xsl:when>
					<xsl:otherwise><xsl:value-of select="2*number(text_padding) + 6"/></xsl:otherwise>
				</xsl:choose>
			</xsl:when>
			<xsl:when test="$theme='curve'">
				<xsl:choose>
					<xsl:when test="display_header='no' and close_by='button'"><xsl:value-of select="number(text_padding) + 16"/></xsl:when>
					<xsl:when test="display_header='no' and close_by!='button'"><xsl:value-of select="2*number(text_padding) + 16"/></xsl:when>
					<xsl:otherwise><xsl:value-of select="2*number(text_padding) + 17"/></xsl:otherwise>
				</xsl:choose>
			</xsl:when>
			<xsl:when test="$theme='gradient'">
				<xsl:choose>
					<xsl:when test="display_header='no' and close_by='button'"><xsl:value-of select="number(text_padding) + 40"/></xsl:when>
					<xsl:when test="display_header='no' and close_by!='button'"><xsl:value-of select="2*number(text_padding) + 40"/></xsl:when>
					<xsl:otherwise><xsl:value-of select="2*number(text_padding) + 41"/></xsl:otherwise>
				</xsl:choose>
			</xsl:when>
			...
			<xsl:when test="$theme='text'">
				<xsl:choose>
					<xsl:when test="display_header='no' and close_by='button'"><xsl:value-of select="2*number(stroke_weight) + number(text_padding)"/></xsl:when>
					<xsl:when test="display_header='no' and close_by!='button'"><xsl:value-of select="2*(number(stroke_weight) + number(text_padding))"/></xsl:when>
					<xsl:otherwise><xsl:value-of select="2*(number(stroke_weight) + number(text_padding)) + 1"/></xsl:otherwise>
				</xsl:choose>
			</xsl:when>
			<xsl:when test="$theme='custom'">
				<xsl:choose>
					<xsl:when test="display_header='no' and close_by='button'"><xsl:value-of select="2*number($border-width-custom) + number(text_padding)"/></xsl:when>
					<xsl:when test="display_header='no' and close_by!='button'"><xsl:value-of select="2*(number($border-width-custom) + number(text_padding))"/></xsl:when>
					<xsl:otherwise><xsl:value-of select="2*(number(stroke_weight) + number(text_padding))"/></xsl:otherwise>
				</xsl:choose>
			</xsl:when>
	...
	<div>
		...
		<xsl:attribute name="data-adjuster"><xsl:value-of select="$adjuster"/></xsl:attribute>
		<xsl:choose>
			<xsl:when test="$theme='simple'">
				...
				<xsl:variable name="css-simple-cl-outer-box"><xsl:if test="close_by='click'">cursor: pointer; </xsl:if><xsl:if test="size_to='container'">height: <xsl:value-of select="number($height) - 2"/>px; </xsl:if>background-color: <xsl:value-of select="$border-color-outer-simple"/>; <xsl:value-of select="$style-box-shadow"/></xsl:variable>
				<xsl:variable name="css-simple-cl-middle-box"><xsl:if test="size_to='container'">height: <xsl:value-of select="number($height) - 6"/>px; </xsl:if>background-color: <xsl:value-of select="$border-color-main-simple"/>;</xsl:variable>
				<xsl:variable name="css-simple-cl-inner-box"><xsl:if test="size_to='container'">height: <xsl:value-of select="number($height) - 8"/>px; </xsl:if>background-color: <xsl:value-of select="$border-color-inner-simple"/>;</xsl:variable>
				<xsl:variable name="css-simple-cl-header-box-empty">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'">background-color: <xsl:value-of select="$bg-color-simple"/>; padding: <xsl:value-of select="header_padding"/>px <xsl:value-of select="header_padding"/>px <xsl:value-of select="0.5*number(header_padding)"/>px 0 !important;</xsl:when>
				...
				<xsl:variable name="css-simple-cl-header-close-btn">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'">padding: 0 !important; width: 0.5em; margin: 0 0 0 auto !important; color: <xsl:value-of select="$border-color-outer-simple"/>;</xsl:when>
								<xsl:otherwise></xsl:otherwise>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>
							<xsl:choose>
								<xsl:when test="close_by='button'">text-shadow: 1px 1px 2px <xsl:value-of select="$border-color-outer-simple"/>; color: <xsl:value-of select="$bg-color-simple"/>;</xsl:when>
								<xsl:otherwise></xsl:otherwise>
							</xsl:choose>
						</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-simple-cl-txt-container">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'">border-style: none; background-color: <xsl:value-of select="$bg-color-simple"/>; padding: 0 <xsl:value-of select="text_padding"/>px <xsl:value-of select="text_padding"/>px <xsl:value-of select="text_padding"/>px;</xsl:when>
								<xsl:otherwise>border-style: none; background-color: <xsl:value-of select="$bg-color-simple"/>; padding: <xsl:value-of select="text_padding"/>px;</xsl:otherwise>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>background-color: <xsl:value-of select="$bg-color-simple"/>; padding: <xsl:value-of select="text_padding"/>px;</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-simple-cl-header-box">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'"></xsl:when>
								<xsl:otherwise></xsl:otherwise>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>background-color: <xsl:value-of select="$border-color-inner-simple"/>; background-image: -o-linear-gradient(90deg,<xsl:value-of select="$border-color-inner-simple"/> 0%,<xsl:value-of select="$border-color-main-simple"/> 100%); background-image: -ms-linear-gradient(90deg,<xsl:value-of select="$border-color-inner-simple"/> 0%,<xsl:value-of select="$border-color-main-simple"/> 100%); background-image: -moz-linear-gradient(90deg,<xsl:value-of select="$border-color-inner-simple"/> 0%,<xsl:value-of select="$border-color-main-simple"/> 100%); background-image: -webkit-linear-gradient(90deg,<xsl:value-of select="$border-color-inner-simple"/> 0%,<xsl:value-of select="$border-color-main-simple"/> 100%); background-image: linear-gradient(0deg,<xsl:value-of select="$border-color-inner-simple"/> 0%,<xsl:value-of select="$border-color-main-simple"/> 100%);</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-simple-cl-header-txt-box">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'"></xsl:when>
						...
						<xsl:otherwise>color: <xsl:value-of select="$bg-color-simple"/>; padding: <xsl:value-of select="header_padding"/>px;</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-simple-cl-header-btn-box">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'"></xsl:when>
						...
						<xsl:otherwise>
							<xsl:choose>
								<xsl:when test="close_by='button'">padding: <xsl:value-of select="header_padding"/>px <xsl:value-of select="header_padding"/>px <xsl:value-of select="header_padding"/>px 0;</xsl:when>
								<xsl:otherwise></xsl:otherwise>
							</xsl:choose>
						</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-simple-cl-txt-box"><xsl:if test="size_to='container'">overflow-y: auto; </xsl:if></xsl:variable>
				
				<xsl:if test="display_header!='no'">
					<div class="style-custom" data-ie9="1" style="display: none">
						<div class="rule" data-ie9="1">
							<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-header-box</xsl:attribute>
							<span class="rule-dynamic" data-ie9="1">
								<xsl:attribute name="data-type">linear-gradient</xsl:attribute>
								<xsl:attribute name="data-angle">0</xsl:attribute>
								<xsl:attribute name="data-colors"><xsl:value-of select="$border-color-inner-simple"/>|0;<xsl:value-of select="$border-color-main-simple"/>|100</xsl:attribute>
							</span>
						</div>
					</div>
				</xsl:if>
				...
				<div>
					...
					<xsl:if test="close_by='click'"><xsl:attribute name="title"><xsl:value-of select="close_title"/></xsl:attribute></xsl:if>
					<div>
						...
						<div>
							...
							<xsl:choose>
								<xsl:when test="display_header='no'">
									<xsl:if test="close_by='button'">
										<div>
											<xsl:attribute name="class">cl-header-box cl-header-box-empty</xsl:attribute>
											<xsl:attribute name="style"><xsl:value-of select="$css-simple-cl-header-box"/><xsl:value-of select="$css-simple-cl-header-box-empty"/></xsl:attribute>
											<div>
												<xsl:attribute name="class">cl-header-close-btn</xsl:attribute>
												<xsl:attribute name="style"><xsl:value-of select="$css-simple-cl-header-close-btn"/></xsl:attribute>
								...
								<xsl:otherwise>
									<div>
										<xsl:attribute name="class">cl-header-box</xsl:attribute>
										<xsl:attribute name="style"><xsl:value-of select="$css-simple-cl-header-box"/></xsl:attribute>
										<table cellpadding="0" cellspacing="0" border="0">
											<xsl:attribute name="class">cl-header-table</xsl:attribute>
											<tr>
												<td>
													<xsl:attribute name="class">cl-header-td cl-header-txt-box</xsl:attribute>
													<xsl:attribute name="style"><xsl:value-of select="$css-simple-cl-header-txt-box"/></xsl:attribute>
													<xsl:value-of select="text_header" disable-output-escaping="yes"/>
												</td>
												<xsl:if test="close_by='button'">
													<td>
														<xsl:attribute name="class">cl-header-td cl-header-btn-box</xsl:attribute>
														<xsl:attribute name="style"><xsl:value-of select="$css-simple-cl-header-btn-box"/></xsl:attribute>
														<div>
															<xsl:attribute name="title"><xsl:value-of select="close_title"/></xsl:attribute>
															<xsl:attribute name="class">cl-header-close-btn</xsl:attribute>
															<xsl:attribute name="style"><xsl:value-of select="$css-simple-cl-header-close-btn"/></xsl:attribute>
			...
			<xsl:when test="$theme='light'">
				...
				<xsl:variable name="header-color-light" select="header_color"/>
				<xsl:variable name="header-color2-light">
					<xsl:call-template name="getcolor">
						<xsl:with-param name="color.base" select="$header-color-light"/>
						<xsl:with-param name="color.base.type">color1</xsl:with-param>
						<xsl:with-param name="color.target.type">color2</xsl:with-param>
					</xsl:call-template>
				</xsl:variable>

				<xsl:variable name="css-light-cl-outer-box"><xsl:if test="close_by='click'">cursor: pointer; </xsl:if><xsl:if test="size_to='container'">height: <xsl:value-of select="number($height) - 2"/>px; </xsl:if>background-color: <xsl:value-of select="$bg-color-light"/>; border-color: <xsl:value-of select="$border-color-light"/>; -moz-border-radius: 5px; -webkit-border-radius: 5px; border-radius: 5px; <xsl:value-of select="$style-box-shadow"/></xsl:variable>
				<xsl:variable name="css-light-cl-header-box-empty">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'">padding: <xsl:value-of select="header_padding"/>px <xsl:value-of select="header_padding"/>px <xsl:value-of select="0.5*number(header_padding)"/>px 0 !important; -moz-border-radius: 4px 4px 0 0; -webkit-border-radius: 4px 4px 0 0; border-radius: 4px 4px 0 0;</xsl:when>
								<xsl:otherwise></xsl:otherwise>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>
				...
				<xsl:variable name="css-light-cl-header-btn-box">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'"></xsl:when>
				...
				<xsl:variable name="css-light-cl-header-close-btn">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'">padding: 0 !important; width: 0.5em; margin: 0 0 0 auto !important; color: <xsl:value-of select="$border-color-light"/>;</xsl:when>
								<xsl:otherwise></xsl:otherwise>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>
							<xsl:choose>
								<xsl:when test="close_by='button'">text-shadow: 1px 1px 2px <xsl:value-of select="$header-color-light"/>; color: <xsl:value-of select="$border-color-light"/>;</xsl:when>
								<xsl:otherwise></xsl:otherwise>
							</xsl:choose>
						</xsl:otherwise>
					</xsl:choose>
				...
				<xsl:variable name="css-light-cl-txt-container">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'">border-style: none; background-color: <xsl:value-of select="$bg-color-light"/>; padding: 0 <xsl:value-of select="text_padding"/>px <xsl:value-of select="text_padding"/>px <xsl:value-of select="text_padding"/>px; -moz-border-radius: 0 0 4px 4px; -webkit-border-radius: 0 0 4px 4px; border-radius: 0 0 4px 4px;</xsl:when>
								<xsl:otherwise>border-style: none; background-color: <xsl:value-of select="$bg-color-light"/>; padding: <xsl:value-of select="text_padding"/>px; -moz-border-radius: 0 0 4px 4px; -webkit-border-radius: 0 0 4px 4px; border-radius: 0 0 4px 4px;</xsl:otherwise>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>border-color: <xsl:value-of select="$border-color-light"/>; border-style: solid none none none; border-width: 1px 0 0 0; background-color: <xsl:value-of select="$bg-color-light"/>; padding: <xsl:value-of select="text_padding"/>px; -moz-border-radius: 0 0 4px 4px; -webkit-border-radius: 0 0 4px 4px; border-radius: 0 0 4px 4px;</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-light-cl-header-box">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'"></xsl:when>
						...
						<xsl:otherwise>background-color: <xsl:value-of select="$header-color-light"/>; -moz-border-radius: 4px 4px 0 0; -webkit-border-radius: 4px 4px 0 0; border-radius: 4px 4px 0 0; background-image: -o-linear-gradient(90deg,<xsl:value-of select="$header-color-light"/> 0%,<xsl:value-of select="$header-color2-light"/> 100%); background-image: -ms-linear-gradient(90deg,<xsl:value-of select="$header-color-light"/> 0%,<xsl:value-of select="$header-color2-light"/> 100%); background-image: -moz-linear-gradient(90deg,<xsl:value-of select="$header-color-light"/> 0%,<xsl:value-of select="$header-color2-light"/> 100%); background-image: -webkit-linear-gradient(90deg,<xsl:value-of select="$header-color-light"/> 0%,<xsl:value-of select="$header-color2-light"/> 100%); background-image: linear-gradient(0deg,<xsl:value-of select="$header-color-light"/> 0%,<xsl:value-of select="$header-color2-light"/> 100%);</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>

				<xsl:variable name="css-light-cl-header-txt-box">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'"></xsl:when>
						...
						<xsl:otherwise>color: <xsl:value-of select="$border-color-light"/>; padding: <xsl:value-of select="header_padding"/>px;</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>

				<xsl:variable name="css-light-cl-txt-box"><xsl:if test="size_to='container'">overflow-y: auto;</xsl:if></xsl:variable>
					...
					<div class="style-custom" data-ie9="1" style="display: none">
						<div class="rule">
							...
							<span class="rule-dynamic" data-ie9="1">
								<xsl:attribute name="data-type">linear-gradient</xsl:attribute>
								<xsl:attribute name="data-angle">0</xsl:attribute>
								<xsl:attribute name="data-colors"><xsl:value-of select="$header-color-light"/>|0;<xsl:value-of select="$header-color2-light"/>|100</xsl:attribute>
							</span>
						</div>
					</div>
				</xsl:if>
						...
						<xsl:choose>
							<xsl:when test="display_header='no'">
								<xsl:if test="close_by='button'">
									<div>
										<xsl:attribute name="class">cl-header-box cl-header-box-empty</xsl:attribute>
										<xsl:attribute name="style"><xsl:value-of select="$css-light-cl-header-box"/> <xsl:value-of select="$css-light-cl-header-box-empty"/></xsl:attribute>
										<div>
											<xsl:attribute name="class">cl-header-close-btn</xsl:attribute>
											<xsl:attribute name="style"><xsl:value-of select="$css-light-cl-header-close-btn"/></xsl:attribute>
											<xsl:attribute name="title"><xsl:value-of select="close_title"/></xsl:attribute>
											&#215;
										</div>
									</div>
							...
							<xsl:otherwise>
								<div>
									<xsl:attribute name="class">cl-header-box</xsl:attribute>
									<xsl:attribute name="style"><xsl:value-of select="$css-light-cl-header-box"/></xsl:attribute>
									<table cellpadding="0" cellspacing="0" border="0">
										<xsl:attribute name="class">cl-header-table</xsl:attribute>
										<tr>
											<td>
												<xsl:attribute name="class">cl-header-td cl-header-txt-box</xsl:attribute>
												<xsl:attribute name="style"><xsl:value-of select="$css-light-cl-header-txt-box"/></xsl:attribute>
												<xsl:value-of select="text_header" disable-output-escaping="yes"/>
											</td>
											<xsl:if test="close_by='button'">
												<td>
													<xsl:attribute name="class">cl-header-td cl-header-btn-box</xsl:attribute>
													<xsl:attribute name="style"><xsl:value-of select="$css-light-cl-header-btn-box"/></xsl:attribute>
													<div>
														<xsl:attribute name="class">cl-header-close-btn</xsl:attribute>
														<xsl:attribute name="style"><xsl:value-of select="$css-light-cl-header-close-btn"/></xsl:attribute>
														<xsl:attribute name="title"><xsl:value-of select="close_title"/></xsl:attribute>
			...
			<xsl:when test="$theme='standard'">
				...
				<xsl:variable name="header-color-standard" select="header_color"/>
				<xsl:variable name="bg-color-standard" select="$bg-color-fixed"/>

				<xsl:variable name="css-standard-cl-outer-box"><xsl:if test="close_by='click'">cursor: pointer; </xsl:if><xsl:if test="size_to='container'">height: <xsl:value-of select="number($height) - 4"/>px; </xsl:if>background-color: <xsl:value-of select="$bg-color-standard"/>; border-color: <xsl:value-of select="$border-color-standard"/>; -moz-border-radius: 10px; -webkit-border-radius: 10px; border-radius: 10px; <xsl:value-of select="$style-box-shadow"/></xsl:variable>
				<xsl:variable name="css-standard-cl-inner-box"><xsl:if test="size_to='container'">height: <xsl:value-of select="number($height) - 4"/>px; </xsl:if> -moz-border-radius: 8px; -webkit-border-radius: 8px; border-radius: 8px;</xsl:variable>
				<xsl:variable name="css-standard-cl-txt-box"><xsl:if test="size_to='container'">overflow-y: auto;</xsl:if></xsl:variable>
				<xsl:variable name="css-standard-cl-header-box-empty">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'">background-color: <xsl:value-of select="$bg-color-standard"/>; padding: <xsl:value-of select="header_padding"/>px <xsl:value-of select="header_padding"/>px <xsl:value-of select="0.5*number(header_padding)"/>px 0 !important; -moz-border-radius: 8px 8px 0 0; -webkit-border-radius: 8px 8px 0 0; border-radius: 8px 8px 0 0;</xsl:when>
								<xsl:otherwise></xsl:otherwise>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>
				...
				<xsl:variable name="css-standard-cl-header-close-btn">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'">padding: 0 !important; width: 0.5em; margin: 0 0 0 auto !important; color: <xsl:value-of select="$border-color-standard"/>;</xsl:when>
								<xsl:otherwise></xsl:otherwise>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>
							<xsl:choose>
								<xsl:when test="close_by='button'">text-shadow: 1px 1px 2px <xsl:value-of select="$bg-color-standard"/>; color: <xsl:value-of select="$border-color-standard"/>;</xsl:when>
								<xsl:otherwise></xsl:otherwise>
							</xsl:choose>
						</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-standard-cl-txt-container">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'">border-style: none; background-color: <xsl:value-of select="$bg-color-standard"/>; padding: 0 <xsl:value-of select="text_padding"/>px <xsl:value-of select="text_padding"/>px <xsl:value-of select="text_padding"/>px; -moz-border-radius: 0 0 8px 8px; -webkit-border-radius: 0 0 8px 8px; border-radius: 0 0 8px 8px;</xsl:when>
								<xsl:otherwise>border-style: none; background-color: <xsl:value-of select="$bg-color-standard"/>; padding: <xsl:value-of select="text_padding"/>px; -moz-border-radius: 8px; -webkit-border-radius: 8px; border-radius: 8px;</xsl:otherwise>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>border-style: solid none none none; border-width: 2px 0 0 0; border-color: <xsl:value-of select="$border-color-standard"/>; background-color: <xsl:value-of select="$bg-color-standard"/>; padding: <xsl:value-of select="text_padding"/>px; -moz-border-radius: 0 0 8px 8px; -webkit-border-radius: 0 0 8px 8px; border-radius: 0 0 8px 8px;</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-standard-cl-header-box">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'"></xsl:when>
						...
						<xsl:otherwise>background-color: <xsl:value-of select="$header-color-standard"/>; -moz-border-radius: 8px 8px 0 0; -webkit-border-radius: 8px 8px 0 0; border-radius: 8px 8px 0 0;</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-standard-cl-header-txt-box">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'"></xsl:when>
						...
						<xsl:otherwise>color: <xsl:value-of select="$border-color-standard"/>; padding: <xsl:value-of select="header_padding"/>px;</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>

				<xsl:variable name="css-standard-cl-header-btn-box">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'"></xsl:when>
						...
						<xsl:choose>
							<xsl:when test="display_header='no'">
								<xsl:if test="close_by='button'">
									<div>
										<xsl:attribute name="class">cl-header-box cl-header-box-empty</xsl:attribute>
										<xsl:attribute name="style"><xsl:value-of select="$css-standard-cl-header-box"/> <xsl:value-of select="$css-standard-cl-header-box-empty"/></xsl:attribute>
										<div>
											<xsl:attribute name="class">cl-header-close-btn cl-header-close-btn-var</xsl:attribute>
											<xsl:attribute name="style"><xsl:value-of select="$css-standard-cl-header-close-btn"/></xsl:attribute>
											<xsl:attribute name="title"><xsl:value-of select="close_title"/></xsl:attribute>
											&#215;
										</div>
									</div>
							...
							<xsl:otherwise>
								<div>
									<xsl:attribute name="class">cl-header-box</xsl:attribute>
									<xsl:attribute name="style"><xsl:value-of select="$css-standard-cl-header-box"/></xsl:attribute>
									<table cellpadding="0" cellspacing="0" border="0">
										<xsl:attribute name="class">cl-header-table</xsl:attribute>
										<tr>
											<td>
												<xsl:attribute name="class">cl-header-td cl-header-txt-box</xsl:attribute>
												<xsl:attribute name="style"><xsl:value-of select="$css-standard-cl-header-txt-box"/></xsl:attribute>
												<xsl:value-of select="text_header" disable-output-escaping="yes"/>
											</td>
											<xsl:if test="close_by='button'">
												<td>
													<xsl:attribute name="class">cl-header-td cl-header-btn-box</xsl:attribute>
													<xsl:attribute name="style"><xsl:value-of select="$css-standard-cl-header-btn-box"/></xsl:attribute>
													<div>
														<xsl:attribute name="class">cl-header-close-btn</xsl:attribute>
														<xsl:attribute name="style"><xsl:value-of select="$css-standard-cl-header-close-btn"/></xsl:attribute>
														<xsl:attribute name="title"><xsl:value-of select="close_title"/></xsl:attribute>
			...
			<xsl:when test="$theme='curve'">
				...
				<xsl:variable name="css-curve-cl-outer-box"><xsl:if test="close_by='click'">cursor: pointer; </xsl:if><xsl:if test="size_to='container'">height: <xsl:value-of select="$height"/>px;</xsl:if> -moz-border-radius: <xsl:value-of select="$shape.0.radius"/>px; -webkit-border-radius: <xsl:value-of select="$shape.0.radius"/>px; border-radius: <xsl:value-of select="$shape.0.radius"/>px; <xsl:value-of select="$style-box-shadow"/></xsl:variable>
				<xsl:variable name="css-curve-cl-inner-box"><xsl:if test="size_to='container'">height: <xsl:value-of select="number($height) - 16"/>px; </xsl:if>padding: 8px; background-color: <xsl:value-of select="$bg-color-curve"/>; -moz-border-radius: <xsl:value-of select="$shape.0.radius"/>px; -webkit-border-radius: <xsl:value-of select="$shape.0.radius"/>px; border-radius: <xsl:value-of select="$shape.0.radius"/>px; -moz-box-shadow: inset 8px 8px 8px rgba(255,255,255,0.35), inset -8px -8px 8px rgba(0,0,0,0.35); -webkit-box-shadow: inset 8px 8px 8px rgba(255,255,255,0.35), inset -8px -8px 8px rgba(0,0,0,0.35) box-shadow: inset 8px 8px 8px rgba(255,255,255,0.35), inset -8px -8px 8px rgba(0,0,0,0.35);</xsl:variable>
				<xsl:variable name="css-curve-cl-txt-box"><xsl:if test="size_to='container'">overflow-y: auto;</xsl:if></xsl:variable>
				<xsl:variable name="css-curve-cl-header-box"></xsl:variable>
				<xsl:variable name="css-curve-cl-header-box-empty">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'">padding: <xsl:value-of select="header_padding"/>px <xsl:value-of select="header_padding"/>px <xsl:value-of select="0.5*number(header_padding)"/>px 0 !important;</xsl:when>
								<xsl:otherwise></xsl:otherwise>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>
				...
				<xsl:variable name="css-curve-cl-header-close-btn">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'">padding: 0 !important; width: 0.5em; margin: 0 0 0 auto !important; color: <xsl:value-of select="$border-color-curve"/>;</xsl:when>
								<xsl:otherwise></xsl:otherwise>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>
							<xsl:choose>
								<xsl:when test="close_by='button'">color: <xsl:value-of select="$border-color-curve"/>;</xsl:when>
								<xsl:otherwise></xsl:otherwise>
							</xsl:choose>
						</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-curve-cl-txt-container">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'">padding: 0 <xsl:value-of select="text_padding"/>px <xsl:value-of select="text_padding"/>px <xsl:value-of select="text_padding"/>px;</xsl:when>
								<xsl:otherwise>padding: <xsl:value-of select="text_padding"/>px;</xsl:otherwise>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>padding: <xsl:value-of select="number(text_padding)"/>px;</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-curve-cl-hr">
					<xsl:choose>
						<xsl:when test="display_header='no'">display: none;</xsl:when>
						<xsl:otherwise>margin: 0 <xsl:value-of select="text_padding"/>px; border-color: <xsl:value-of select="$border-color-curve"/>;</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-curve-cl-header-txt-box">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'"></xsl:when>
						...
						<xsl:otherwise>color: <xsl:value-of select="$border-color-curve"/>; padding: <xsl:value-of select="header_padding"/>px;</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-curve-cl-header-btn-box">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'"></xsl:when>
				...
				<div>
					...
					<div>
						...
						<xsl:choose>
							<xsl:when test="display_header='no'">
								<xsl:if test="close_by='button'">
									<div>
										<xsl:attribute name="class">cl-header-box cl-header-box-empty</xsl:attribute>
										<xsl:attribute name="style"><xsl:value-of select="$css-curve-cl-header-box"/> <xsl:value-of select="$css-curve-cl-header-box-empty"/></xsl:attribute>
										<div>
											<xsl:attribute name="class">cl-header-close-btn</xsl:attribute>
											<xsl:attribute name="style"><xsl:value-of select="$css-curve-cl-header-close-btn"/></xsl:attribute>
											<xsl:attribute name="title"><xsl:value-of select="close_title"/></xsl:attribute>
											&#215;
										</div>
									</div>
							...
							<xsl:otherwise>
								<div>
									<xsl:attribute name="class">cl-header-box</xsl:attribute>
									<xsl:attribute name="style"><xsl:value-of select="$css-curve-cl-header-box"/></xsl:attribute>
									<table cellpadding="0" cellspacing="0" border="0">
										<xsl:attribute name="class">cl-header-table</xsl:attribute>
										<tr>
											<td>
												<xsl:attribute name="class">cl-header-td cl-header-txt-box</xsl:attribute>
												<xsl:attribute name="style"><xsl:value-of select="$css-curve-cl-header-txt-box"/></xsl:attribute>
												<xsl:value-of select="text_header" disable-output-escaping="yes"/>
											</td>
											<xsl:if test="close_by='button'">
												<td>
													<xsl:attribute name="class">cl-header-td cl-header-btn-box</xsl:attribute>
													<xsl:attribute name="style"><xsl:value-of select="$css-curve-cl-header-btn-box"/></xsl:attribute>
													<div>
														<xsl:attribute name="class">cl-header-close-btn</xsl:attribute>
														<xsl:attribute name="style"><xsl:value-of select="$css-curve-cl-header-close-btn"/></xsl:attribute>
														<xsl:attribute name="title"><xsl:value-of select="close_title"/></xsl:attribute>
						...
						<div>
							<xsl:attribute name="class">cl-hr</xsl:attribute>
							<xsl:attribute name="style"><xsl:value-of select="$css-curve-cl-hr"/></xsl:attribute>
							&#160;
						</div>
						<div>
							<xsl:attribute name="class">cl-txt-container</xsl:attribute>
			...
			<xsl:when test="$theme='gradient'">
				...
				<xsl:variable name="css-gradient-cl-txt-box"><xsl:if test="size_to='container'">overflow-y: auto; </xsl:if></xsl:variable>
				<xsl:variable name="css-gradient-cl-header-box"></xsl:variable>
				<xsl:variable name="css-gradient-cl-header-box-empty">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'">padding: <xsl:value-of select="header_padding"/>px <xsl:value-of select="header_padding"/>px <xsl:value-of select="0.5*number(header_padding)"/>px 0 !important;</xsl:when>
				...
				<xsl:variable name="css-gradient-cl-header-close-btn">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'">padding: 0 !important; width: 0.5em; margin: 0 0 0 auto !important; color: <xsl:value-of select="$border-color-gradient"/>;</xsl:when>
								<xsl:otherwise></xsl:otherwise>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>
							<xsl:choose>
								<xsl:when test="close_by='button'">text-shadow: 1px 1px 2px <xsl:value-of select="$bg-color-gradient"/>; color: <xsl:value-of select="$border-color-gradient"/>;</xsl:when>
								<xsl:otherwise></xsl:otherwise>
							</xsl:choose>
						</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-gradient-cl-txt-container">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'">padding: 0 <xsl:value-of select="text_padding"/>px <xsl:value-of select="text_padding"/>px <xsl:value-of select="text_padding"/>px;</xsl:when>
				...
				<xsl:variable name="css-gradient-cl-hr">
					<xsl:choose>
						<xsl:when test="display_header='no'">display: none;</xsl:when>
						<xsl:otherwise>margin: 0 <xsl:value-of select="text_padding"/>px; border-color: <xsl:value-of select="$border-color-gradient"/>;</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-gradient-cl-header-txt-box">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'"></xsl:when>
						...
						<xsl:otherwise>color: <xsl:value-of select="$border-color-gradient"/>; padding: <xsl:value-of select="header_padding"/>px;</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-gradient-cl-header-btn-box">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'"></xsl:when>
																				...
																				<div>
																					...
																					<div>
																						...
																						<div>
																							...
																							<xsl:choose>
																								<xsl:when test="display_header='no'">
																									<xsl:if test="close_by='button'">
																										<div>
																											<xsl:attribute name="class">cl-header-box cl-header-box-empty</xsl:attribute>
																											<xsl:attribute name="style"><xsl:value-of select="$css-gradient-cl-header-box"/><xsl:value-of select="$css-gradient-cl-header-box-empty"/></xsl:attribute>
																											<div>
																												<xsl:attribute name="class">cl-header-close-btn</xsl:attribute>
																												<xsl:attribute name="style"><xsl:value-of select="$css-gradient-cl-header-close-btn"/></xsl:attribute>
																												<xsl:attribute name="title"><xsl:value-of select="close_title"/></xsl:attribute>
																												&#215;
																											</div>
																										</div>
																								...
																								<xsl:otherwise>
																									<div>
																										<xsl:attribute name="class">cl-header-box</xsl:attribute>
																										<xsl:attribute name="style"><xsl:value-of select="$css-gradient-cl-header-box"/></xsl:attribute>
																										<table cellpadding="0" cellspacing="0" border="0">
																											<xsl:attribute name="class">cl-header-table</xsl:attribute>
																											<tr>
																												<td>
																													<xsl:attribute name="class">cl-header-td cl-header-txt-box</xsl:attribute>
																													<xsl:attribute name="style"><xsl:value-of select="$css-gradient-cl-header-txt-box"/></xsl:attribute>
																													<xsl:value-of select="text_header" disable-output-escaping="yes"/>
																												</td>
																												<xsl:if test="close_by='button'">
																													<td>
																														<xsl:attribute name="class">cl-header-td cl-header-btn-box</xsl:attribute>
																														<xsl:attribute name="style"><xsl:value-of select="$css-gradient-cl-header-btn-box"/></xsl:attribute>
																														<div>
																															<xsl:attribute name="class">cl-header-close-btn</xsl:attribute>
																															<xsl:attribute name="style"><xsl:value-of select="$css-gradient-cl-header-close-btn"/></xsl:attribute>
																															<xsl:attribute name="title"><xsl:value-of select="close_title"/></xsl:attribute>
																							...
																							<div>
																								<xsl:attribute name="class">cl-hr</xsl:attribute>
																								<xsl:attribute name="style"><xsl:value-of select="$css-gradient-cl-hr"/></xsl:attribute>
																								&#160;
																							</div>
																							<div>
																								<xsl:attribute name="class">cl-txt-container</xsl:attribute>
			...
			<xsl:when test="$theme='relief'">
				...
				<xsl:variable name="css-relief-cl-inner-box">width: <xsl:value-of select="number($width) - 8"/>px; <xsl:if test="size_to='container'">height: <xsl:value-of select="number($height) - 8"/>px;</xsl:if>background-color: <xsl:value-of select="$bg-color-relief"/>; -moz-border-radius: 9px; -webkit-border-radius: 9px; border-radius: 9px;</xsl:variable>
				<xsl:variable name="css-relief-cl-txt-box"><xsl:if test="size_to='container'">overflow-y: auto;</xsl:if></xsl:variable>

				<xsl:variable name="css-relief-cl-header-box">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'"></xsl:when>
						...
						<xsl:otherwise>background-color: <xsl:value-of select="$color.darker"/>; -moz-border-radius: 9px 9px 0 0; -webkit-border-radius: 9px 9px 0 0; border-radius: 9px 9px 0 0; background-image: -o-linear-gradient(-90deg,<xsl:value-of select="$color.lighter"/> 0%,<xsl:value-of select="$color.darker"/> 100%); background-image: -ms-linear-gradient(-90deg,<xsl:value-of select="$color.lighter"/> 0%,<xsl:value-of select="$color.darker"/> 100%); background-image: -moz-linear-gradient(-90deg,<xsl:value-of select="$color.lighter"/> 0%,<xsl:value-of select="$color.darker"/> 100%); background-image: -webkit-linear-gradient(-90deg,<xsl:value-of select="$color.lighter"/> 0%,<xsl:value-of select="$color.darker"/> 100%); background-image: linear-gradient(180deg,<xsl:value-of select="$color.lighter"/> 0%,<xsl:value-of select="$color.darker"/> 100%);</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-relief-cl-header-box-1">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'"></xsl:when>
						...
						<xsl:otherwise>background-color: <xsl:value-of select="$color.dark"/>; -moz-border-radius: 8px 8px 0 0; -webkit-border-radius: 8px 8px 0 0; border-radius: 8px 8px 0 0; background-image: -o-linear-gradient(-90deg,<xsl:value-of select="$color.light"/> 0%,<xsl:value-of select="$color.dark"/> 100%); background-image: -ms-linear-gradient(-90deg,<xsl:value-of select="$color.light"/> 0%,<xsl:value-of select="$color.dark"/> 100%); background-image: -moz-linear-gradient(-90deg,<xsl:value-of select="$color.light"/> 0%,<xsl:value-of select="$color.dark"/> 100%); background-image: -webkit-linear-gradient(-90deg,<xsl:value-of select="$color.light"/> 0%,<xsl:value-of select="$color.dark"/> 100%); background-image: linear-gradient(180deg,<xsl:value-of select="$color.light"/> 0%,<xsl:value-of select="$color.dark"/> 100%);</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-relief-cl-header-box-2">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'"></xsl:when>
						...
						<xsl:otherwise>background-color: <xsl:value-of select="$border-color-relief"/>; -moz-border-radius: 7px 7px 0 0; -webkit-border-radius: 7px 7px 0 0; border-radius: 7px 7px 0 0;</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-relief-cl-header-box-empty">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'">padding: <xsl:value-of select="header_padding"/>px <xsl:value-of select="header_padding"/>px <xsl:value-of select="0.5*number(header_padding)"/>px 0 !important; -moz-border-radius: 50%; -webkit-border-radius: 50%; border-radius: 50%;</xsl:when>
								<xsl:otherwise></xsl:otherwise>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>
				...
				<xsl:variable name="css-relief-cl-header-close-btn">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'">padding: 0 !important; margin: 0 0 0 auto !important; background-color: <xsl:value-of select="$border-color-relief"/>; color: <xsl:value-of select="$bg-color-relief"/>; -moz-border-radius: 50%; -webkit-border-radius: 50%; border-radius: 50%;</xsl:when>
								<xsl:otherwise></xsl:otherwise>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>
							<xsl:choose>
								<xsl:when test="close_by='button'">background-color: <xsl:value-of select="$bg-color-relief"/>; color: <xsl:value-of select="$border-color-relief"/>; -moz-border-radius: 50%; -webkit-border-radius: 50%; border-radius: 50%;</xsl:when>
								<xsl:otherwise></xsl:otherwise>
							</xsl:choose>
						</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-relief-cl-txt-container">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'">background-color: <xsl:value-of select="$bg-color-relief"/>; padding: 0 <xsl:value-of select="text_padding"/>px <xsl:value-of select="text_padding"/>px <xsl:value-of select="text_padding"/>px; -moz-border-radius: 0 0 9px 9px; -webkit-border-radius: 0 0 9px 9px; border-radius: 0 0 9px 9px;</xsl:when>
								<xsl:otherwise>position: relative; border-style: none; background-color: <xsl:value-of select="$bg-color-relief"/>; padding: <xsl:value-of select="text_padding"/>px; -moz-border-radius: 9px; -webkit-border-radius: 9px; border-radius: 9px;</xsl:otherwise>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>background-color: <xsl:value-of select="$bg-color-relief"/>; padding: <xsl:value-of select="text_padding"/>px; -moz-border-radius: 0 0 9px 9px; -webkit-border-radius: 0 0 9px 9px; border-radius: 0 0 9px 9px;</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-relief-cl-header-txt-box">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'"></xsl:when>
						...
						<xsl:otherwise>color: <xsl:value-of select="$border-color-relief"/>; padding: <xsl:value-of select="header_padding"/>px;</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-relief-cl-header-btn-box">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'"></xsl:when>
				...
				<div class="style-custom" data-ie9="1" style="display: none">
					...
					<xsl:if test="display_header!='no'">
						...
						<div class="rule">
							<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-header-box-1</xsl:attribute>
							<span class="rule-dynamic" data-ie9="1">
								<xsl:attribute name="data-type">linear-gradient</xsl:attribute>
								<xsl:attribute name="data-angle">180</xsl:attribute>
								<xsl:attribute name="data-colors"><xsl:value-of select="$color.light"/>|0;<xsl:value-of select="$color.dark"/>|100</xsl:attribute>
							</span>
						</div>
					</xsl:if>
				</div>
					...
					<div>
						...
						<div>
							...
							<div>
								...
								<div>
									<xsl:attribute name="class">cl-inner-box cl-inner-box</xsl:attribute>
									...
									<xsl:choose>
										<xsl:when test="display_header='no'">
											<xsl:if test="close_by='button'">
												<div>
													<xsl:attribute name="class">cl-header-box cl-header-box-empty</xsl:attribute>
													<xsl:attribute name="style"><xsl:value-of select="$css-relief-cl-header-box"/><xsl:value-of select="$css-relief-cl-header-box-empty"/></xsl:attribute>
													<div>
														<xsl:attribute name="class">cl-header-close-btn</xsl:attribute>
														<xsl:attribute name="style"><xsl:value-of select="$css-relief-cl-header-close-btn"/></xsl:attribute>
														<xsl:attribute name="title"><xsl:value-of select="close_title"/></xsl:attribute>
														&#215;
													</div>
												</div>
										...
										<xsl:otherwise>
											<div>
												<xsl:attribute name="class">cl-header-box</xsl:attribute>
												<xsl:attribute name="style"><xsl:value-of select="$css-relief-cl-header-box"/></xsl:attribute>
												<div>
													<xsl:attribute name="class">cl-header-box-1</xsl:attribute>
													<xsl:attribute name="style"><xsl:value-of select="$css-relief-cl-header-box-1"/></xsl:attribute>
													<div>
														<xsl:attribute name="class">cl-header-box-2</xsl:attribute>
														<xsl:attribute name="style"><xsl:value-of select="$css-relief-cl-header-box-2"/></xsl:attribute>
														<table cellpadding="0" cellspacing="0" border="0">
															<xsl:attribute name="class">cl-header-table</xsl:attribute>
															<tr>
																<td>
																	<xsl:attribute name="class">cl-header-td cl-header-txt-box</xsl:attribute>
																	<xsl:attribute name="style"><xsl:value-of select="$css-relief-cl-header-txt-box"/></xsl:attribute>
																	<xsl:value-of select="text_header" disable-output-escaping="yes"/>
																</td>
																<xsl:if test="close_by='button'">
																	<td>
																		<xsl:attribute name="class">cl-header-td cl-header-btn-box</xsl:attribute>
																		<xsl:attribute name="style"><xsl:value-of select="$css-relief-cl-header-btn-box"/></xsl:attribute>
																		<div>
																			<xsl:attribute name="class">cl-header-close-btn</xsl:attribute>
																			<xsl:attribute name="style"><xsl:value-of select="$css-relief-cl-header-close-btn"/></xsl:attribute>
																			<xsl:attribute name="title"><xsl:value-of select="close_title"/></xsl:attribute>
			...
			<xsl:when test="$theme='text'">
				...
				<xsl:variable name="radius_inner">
					<xsl:choose>
						<xsl:when test="(number(border_radius)-number(stroke_weight)) &lt; 0">0</xsl:when>
						<xsl:otherwise><xsl:value-of select="number(border_radius)-number(stroke_weight)"/></xsl:otherwise>
					</xsl:choose>
				</xsl:variable>

				<xsl:variable name="css-text-cl-outer-box"><xsl:if test="close_by='click'">cursor: pointer; </xsl:if><xsl:if test="size_to='container'">height: <xsl:value-of select="number($height) - 2*number(stroke_weight)"/>px; </xsl:if> background-color: <xsl:value-of select="$bg-color-text"/>; border-width: <xsl:value-of select="stroke_weight"/>px; border-color: <xsl:value-of select="$border-color-text"/>; background-image: -o-linear-gradient(<xsl:value-of select="90-number(gradient_angle)"/>deg,<xsl:value-of select="$bg-color-text"/> 0%,<xsl:value-of select="$bg-color-text-gradient"/> 100%); background-image: -ms-linear-gradient(<xsl:value-of select="90-number(gradient_angle)"/>deg,<xsl:value-of select="$bg-color-text"/> 0%,<xsl:value-of select="$bg-color-text-gradient"/> 100%); background-image: -moz-linear-gradient(<xsl:value-of select="90-number(gradient_angle)"/>deg,<xsl:value-of select="$bg-color-text"/> 0%,<xsl:value-of select="$bg-color-text-gradient"/> 100%); background-image: -webkit-linear-gradient(<xsl:value-of select="90-number(gradient_angle)"/>deg,<xsl:value-of select="$bg-color-text"/> 0%,<xsl:value-of select="$bg-color-text-gradient"/> 100%); background-image: linear-gradient(<xsl:value-of select="gradient_angle"/>deg,<xsl:value-of select="$bg-color-text"/> 0%,<xsl:value-of select="$bg-color-text-gradient"/> 100%); -moz-border-radius: <xsl:value-of select="border_radius"/>px; -webkit-border-radius: <xsl:value-of select="border_radius"/>px; border-radius: <xsl:value-of select="border_radius"/>px;<xsl:value-of select="$style-box-shadow"/></xsl:variable>
				<xsl:variable name="css-text-cl-txt-box"><xsl:if test="size_to='container'">overflow-y: auto;</xsl:if></xsl:variable>
				<xsl:variable name="css-text-cl-header-box">
					<xsl:choose>
						<xsl:when test="display_header='no'">
						</xsl:when>
						<xsl:otherwise>-moz-border-radius: <xsl:value-of select="$radius_inner"/>px <xsl:value-of select="$radius_inner"/>px 0 0; -webkit-border-radius: <xsl:value-of select="$radius_inner"/>px <xsl:value-of select="$radius_inner"/>px 0 0; border-radius: <xsl:value-of select="$radius_inner"/>px <xsl:value-of select="$radius_inner"/>px 0 0;</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-text-cl-header-box-empty">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'">padding: <xsl:value-of select="header_padding"/>px <xsl:value-of select="header_padding"/>px <xsl:value-of select="0.5*number(header_padding)"/>px 0 !important;</xsl:when>
				...
				<xsl:variable name="css-text-cl-header-close-btn">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'">margin: 0 0 0 auto !important; background-color: <xsl:value-of select="$border-color-text"/>; color: <xsl:value-of select="$bg-color-text-gradient"/>; -moz-border-radius: 50%; -webkit-border-radius: 50%; border-radius: 50%;</xsl:when>
								<xsl:otherwise></xsl:otherwise>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>
							<xsl:choose>
								<xsl:when test="close_by='button'">background-color: <xsl:value-of select="$border-color-text"/>; color: <xsl:value-of select="$bg-color-text-gradient"/>; -moz-border-radius: 50%; -webkit-border-radius: 50%; border-radius: 50%;</xsl:when>
								<xsl:otherwise></xsl:otherwise>
							</xsl:choose>
						</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-text-cl-txt-container">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'">padding: 0 <xsl:value-of select="text_padding"/>px <xsl:value-of select="text_padding"/>px <xsl:value-of select="text_padding"/>px; -moz-border-radius: 0 0 <xsl:value-of select="$radius_inner"/>px <xsl:value-of select="$radius_inner"/>px; -webkit-border-radius: 0 0 <xsl:value-of select="$radius_inner"/>px <xsl:value-of select="$radius_inner"/>px; border-radius: 0 0 <xsl:value-of select="$radius_inner"/>px <xsl:value-of select="$radius_inner"/>px;</xsl:when>
								<xsl:otherwise>padding: <xsl:value-of select="text_padding"/>px; -moz-border-radius: <xsl:value-of select="$radius_inner"/>px; -webkit-border-radius: <xsl:value-of select="$radius_inner"/>px; border-radius: <xsl:value-of select="$radius_inner"/>px;</xsl:otherwise>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>padding: <xsl:value-of select="text_padding"/>px; -moz-border-radius: 0 0 <xsl:value-of select="$radius_inner"/>px <xsl:value-of select="$radius_inner"/>px; -webkit-border-radius: 0 0 <xsl:value-of select="$radius_inner"/>px <xsl:value-of select="$radius_inner"/>px; border-radius: 0 0 <xsl:value-of select="$radius_inner"/>px <xsl:value-of select="$radius_inner"/>px;</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-text-cl-hr">
					<xsl:choose>
						<xsl:when test="display_header='no'">display: none;</xsl:when>
						<xsl:otherwise>margin: 0 <xsl:value-of select="text_padding"/>px; border-color: <xsl:value-of select="$border-color-text"/>;</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-text-cl-header-txt-box">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'"></xsl:when>
						...
						<xsl:otherwise>color: <xsl:value-of select="$border-color-text"/>; padding: <xsl:value-of select="header_padding"/>px;</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-text-cl-header-btn-box">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'"></xsl:when>
				...
				<div class="style-custom" data-ie9="1" style="display: none">
					<div class="rule">
						<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-outer-box-var</xsl:attribute>
						<span class="rule-dynamic" data-ie9="1">
							<xsl:attribute name="data-type">linear-gradient</xsl:attribute>
				...
				<div>
					...
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:if test="close_by='button'">
								<div>
									<xsl:attribute name="class">cl-header-box cl-header-box-empty</xsl:attribute>
									<xsl:attribute name="style"><xsl:value-of select="$css-text-cl-header-box"/><xsl:value-of select="$css-text-cl-header-box-empty"/></xsl:attribute>
									<div>
										<xsl:attribute name="class">cl-header-close-btn</xsl:attribute>
										<xsl:attribute name="style"><xsl:value-of select="$css-text-cl-header-close-btn"/></xsl:attribute>
										<xsl:attribute name="title"><xsl:value-of select="close_title"/></xsl:attribute>
										&#215;
									</div>
								</div>
						...
						<xsl:otherwise>
							<div>
								<xsl:attribute name="class">cl-header-box</xsl:attribute>
								<xsl:attribute name="style"><xsl:value-of select="$css-text-cl-header-box"/></xsl:attribute>
								<table cellpadding="0" cellspacing="0" border="0">
									<xsl:attribute name="class">cl-header-table</xsl:attribute>
									<tr>
										<td>
											<xsl:attribute name="class">cl-header-td cl-header-txt-box</xsl:attribute>
											<xsl:attribute name="style"><xsl:value-of select="$css-text-cl-header-txt-box"/></xsl:attribute>
											<xsl:value-of select="text_header" disable-output-escaping="yes"/>
										</td>
										<xsl:if test="close_by='button'">
											<td>
												<xsl:attribute name="class">cl-header-td cl-header-btn-box</xsl:attribute>
												<xsl:attribute name="style"><xsl:value-of select="$css-text-cl-header-btn-box"/></xsl:attribute>
												<div>
													<xsl:attribute name="class">cl-header-close-btn</xsl:attribute>
													<xsl:attribute name="style"><xsl:value-of select="$css-text-cl-header-close-btn"/></xsl:attribute>
													<xsl:attribute name="title"><xsl:value-of select="close_title"/></xsl:attribute>
					...
					<div>
						<xsl:attribute name="class">cl-hr</xsl:attribute>
						<xsl:attribute name="style"><xsl:value-of select="$css-text-cl-hr"/></xsl:attribute>
						&#160;
					</div>
					<div>
						<xsl:attribute name="class">cl-txt-container</xsl:attribute>
			...
			<xsl:when test="$theme='custom'">
				...
				<xsl:variable name="header-color-custom" select="header_color"/>
				<xsl:variable name="btn-color-custom" select="$btn-color-fixed"/>
				<xsl:variable name="bg-gradient-color-custom" select="$gradient-color-fixed"/>
				<xsl:variable name="radius_inner">
					<xsl:choose>
						<xsl:when test="(number(border_radius)-number($border-width-custom)) &lt; 0">0</xsl:when>
						<xsl:otherwise><xsl:value-of select="number(border_radius)-number($border-width-custom)"/></xsl:otherwise>
					</xsl:choose>
				</xsl:variable>

				<xsl:variable name="css-custom-cl-outer-box"><xsl:if test="close_by='click'">cursor: pointer; </xsl:if><xsl:if test="size_to='container'">height: <xsl:value-of select="number($height) - 2*number($border-width-custom)"/>px; </xsl:if> background-color: <xsl:value-of select="$bg-color-custom"/>; border-style: <xsl:value-of select="border_style"/> !important; border-width: <xsl:value-of select="$border-width-custom"/>px; border-color: <xsl:value-of select="$border-color-custom"/>; background-image: -o-linear-gradient(<xsl:value-of select="90-number(gradient_angle)"/>deg,<xsl:value-of select="$bg-color-custom"/> 0%,<xsl:value-of select="$bg-gradient-color-custom"/> 100%); background-image: -ms-linear-gradient(<xsl:value-of select="90-number(gradient_angle)"/>deg,<xsl:value-of select="$bg-color-custom"/> 0%,<xsl:value-of select="$bg-gradient-color-custom"/> 100%); background-image: -moz-linear-gradient(<xsl:value-of select="90-number(gradient_angle)"/>deg,<xsl:value-of select="$bg-color-custom"/> 0%,<xsl:value-of select="$bg-gradient-color-custom"/> 100%); background-image: -webkit-linear-gradient(<xsl:value-of select="90-number(gradient_angle)"/>deg,<xsl:value-of select="$bg-color-custom"/> 0%,<xsl:value-of select="$bg-gradient-color-custom"/> 100%); background-image: linear-gradient(<xsl:value-of select="gradient_angle"/>deg,<xsl:value-of select="$bg-color-custom"/> 0%,<xsl:value-of select="$bg-gradient-color-custom"/> 100%); -moz-border-radius: <xsl:value-of select="border_radius"/>px; -webkit-border-radius: <xsl:value-of select="border_radius"/>px; border-radius: <xsl:value-of select="border_radius"/>px;<xsl:value-of select="$style-box-shadow"/></xsl:variable>
				<xsl:variable name="css-custom-cl-txt-box"><xsl:if test="size_to='container'">overflow-y: auto;</xsl:if></xsl:variable>
				<xsl:variable name="css-custom-cl-header-box">
					<xsl:if test="display_header!='no'">background-color: <xsl:value-of select="$header-color-custom"/>; -moz-border-radius: <xsl:value-of select="$radius_inner"/>px <xsl:value-of select="$radius_inner"/>px 0 0; -webkit-border-radius: <xsl:value-of select="$radius_inner"/>px <xsl:value-of select="$radius_inner"/>px 0 0; border-radius: <xsl:value-of select="$radius_inner"/>px <xsl:value-of select="$radius_inner"/>px 0 0;</xsl:if>
				</xsl:variable>
				<xsl:variable name="css-custom-cl-header-box-empty">
					<xsl:if test="display_header='no' and close_by='button'">padding: <xsl:value-of select="header_padding"/>px <xsl:value-of select="header_padding"/>px <xsl:value-of select="0.5*number(header_padding)"/>px 0 !important;</xsl:if>
				</xsl:variable>
				<xsl:variable name="css-custom-cl-header-close-btn">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:if test="close_by='button'">margin: 0 0 0 auto !important; color: <xsl:value-of select="$btn-color-custom"/>; font-size: <xsl:value-of select="btn_size"/>px;</xsl:if>
						</xsl:when>
						<xsl:otherwise>
							<xsl:if test="close_by='button'">font-size: <xsl:value-of select="btn_size"/>px; color: <xsl:value-of select="$btn-color-custom"/>;</xsl:if>
						</xsl:otherwise>
					</xsl:choose>
				</xsl:variable>
				<xsl:variable name="css-custom-cl-txt-container">
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:choose>
								<xsl:when test="close_by='button'">padding: 0 <xsl:value-of select="text_padding"/>px <xsl:value-of select="text_padding"/>px <xsl:value-of select="text_padding"/>px; -moz-border-radius: 0 0 <xsl:value-of select="$radius_inner"/>px <xsl:value-of select="$radius_inner"/>px; -webkit-border-radius: 0 0 <xsl:value-of select="$radius_inner"/>px <xsl:value-of select="$radius_inner"/>px; border-radius: 0 0 <xsl:value-of select="$radius_inner"/>px <xsl:value-of select="$radius_inner"/>px;</xsl:when>
				...
				<xsl:variable name="css-custom-cl-header-txt-box">
					<xsl:if test="display_header!='no'">color: <xsl:value-of select="$border-color-custom"/>; padding: <xsl:value-of select="header_padding"/>px;</xsl:if>
				</xsl:variable>
				<xsl:variable name="css-custom-cl-header-btn-box">
					<xsl:if test="display_header!='no' and close_by='button'">padding: <xsl:value-of select="header_padding"/>px <xsl:value-of select="header_padding"/>px <xsl:value-of select="header_padding"/>px 0;</xsl:if>
				</xsl:variable>
				...
				<div class="style-custom" data-ie9="1" style="display: none">
					<div class="rule">
						...
						<span class="rule-dynamic" data-ie9="1">
							<xsl:attribute name="data-type">linear-gradient</xsl:attribute>
							<xsl:attribute name="data-angle"><xsl:value-of select="gradient_angle"/></xsl:attribute>
							<xsl:attribute name="data-colors"><xsl:value-of select="$bg-color-custom"/>|0;<xsl:value-of select="$bg-gradient-color-custom"/>|100</xsl:attribute>
						</span>
					</div>
				</div>
				<div>
					...
					<xsl:choose>
						<xsl:when test="display_header='no'">
							<xsl:if test="close_by='button'">
								<div>
									<xsl:attribute name="class">cl-header-box cl-header-box-empty</xsl:attribute>
									<xsl:attribute name="style"><xsl:value-of select="$css-custom-cl-header-box"/><xsl:value-of select="$css-custom-cl-header-box-empty"/></xsl:attribute>
									<div>
										<xsl:attribute name="class">cl-header-close-btn</xsl:attribute>
										<xsl:attribute name="style"><xsl:value-of select="$css-custom-cl-header-close-btn"/></xsl:attribute>
										<xsl:attribute name="title"><xsl:value-of select="close_title"/></xsl:attribute>
										&#215;
									</div>
								</div>
						...
						<xsl:otherwise>
							<div>
								<xsl:attribute name="class">cl-header-box</xsl:attribute>
								<xsl:attribute name="style"><xsl:value-of select="$css-custom-cl-header-box"/></xsl:attribute>
								<table cellpadding="0" cellspacing="0" border="0">
									<xsl:attribute name="class">cl-header-table</xsl:attribute>
									<tr>
										<td>
											<xsl:attribute name="class">cl-header-td cl-header-txt-box</xsl:attribute>
											<xsl:attribute name="style"><xsl:value-of select="$css-custom-cl-header-txt-box"/></xsl:attribute>
											<xsl:value-of select="text_header" disable-output-escaping="yes"/>
										</td>
										<xsl:if test="close_by='button'">
											<td>
												<xsl:attribute name="class">cl-header-td cl-header-btn-box</xsl:attribute>
												<xsl:attribute name="style"><xsl:value-of select="$css-custom-cl-header-btn-box"/></xsl:attribute>
												<div>
													<xsl:attribute name="class">cl-header-close-btn</xsl:attribute>
													<xsl:attribute name="style"><xsl:value-of select="$css-custom-cl-header-close-btn"/></xsl:attribute>
													<xsl:attribute name="title"><xsl:value-of select="close_title"/></xsl:attribute>
					...
					<div>
						...
						<div>
							<xsl:attribute name="class">cl-txt-box cl-txt-box</xsl:attribute>
